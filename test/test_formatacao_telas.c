...
void test_lcd1602_scroll_autores_primeira_janela(void)
{
    ...
    lcd1602_formatar_janela_scroll("Autores: Patrik, Janiel e Joao", 0, linha);

    TEST_ASSERT_EQUAL_STRING("Autores: Patrik,", linha);
}
...
void test_lcd1602_scroll_autores_move_para_esquerda(void)
{
    ...
    lcd1602_formatar_janela_scroll("Autores: Patrik, Janiel e Joao", 1, linha);

    TEST_ASSERT_EQUAL_STRING("utores: Patrik, ", linha);
}
...
void test_lcd1602_scroll_autores_reinicia_com_espaco(void)
{
    ...
    lcd1602_formatar_janela_scroll("Autores: Patrik, Janiel e Joao", 30, linha);

    TEST_ASSERT_EQUAL_STRING("    Autores: Pat", linha);
}
