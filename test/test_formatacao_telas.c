...
void test_lcd1602_scroll_autores_primeira_janela(void)
{
    ...
    lcd1602_formatar_janela_scroll("Autores: Janiel - Joao Sanmartin - Patrik", 0, linha);
...
void test_lcd1602_scroll_autores_move_para_esquerda(void)
{
    ...
    lcd1602_formatar_janela_scroll("Autores: Janiel - Joao Sanmartin - Patrik", 1, linha);
...
void test_lcd1602_scroll_autores_reinicia_com_espaco(void)
{
    ...
    lcd1602_formatar_janela_scroll("Autores: Janiel - Joao Sanmartin - Patrik", 41, linha);
